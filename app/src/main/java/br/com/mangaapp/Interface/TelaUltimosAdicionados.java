        ...
        alertDialog.setPositiveButton("Salvar",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (res)
                            Toast.makeText(TelaUltimosAdicionados.this, "Titulo atualizada com sucesso!", Toast.LENGTH_SHORT).show();
                        else
                            Toast.makeText(TelaUltimosAdicionados.this, "Houve um erro ao salvar as alterações!", Toast.LENGTH_SHORT).show();
/*
                        titulos = tituloRepository.listar();*/
                        populaTela();
                    }
        ...
        alertDialog.setPositiveButton("Salvar",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (res) {
                            Toast.makeText(TelaUltimosAdicionados.this, "Titulo salva com sucesso!", Toast.LENGTH_SHORT).show();
                            populaTela();
                        } else {
                            Toast.makeText(TelaUltimosAdicionados.this, "Houve um erro ao salvar a titulo!", Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    dlg.setPositiveButton("Deletar", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            if (list_titulos != null) {
                                ...
                                if (res) {
                                    Toast.makeText(TelaUltimosAdicionados.this, "Titulos deletadas com sucesso!", Toast.LENGTH_SHORT).show();
                                } else {
                                    Toast.makeText(TelaUltimosAdicionados.this, "Houve um erro ao deletar as titulos!", Toast.LENGTH_SHORT).show();
                                }
